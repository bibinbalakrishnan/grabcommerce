    ...
    return (
      <div>
        ...
        <Card centered>
          ...
          <Card.Content><img src="cartgrab.png" style={{ verticalAlign: 'middle', width: '60px', height: '35px' }} />&nbsp;&nbsp;&nbsp;<a href={`exp://exp.host/@vgrab/vgrab?id=${this.props.product.id}`}> <QRCode
            value={`exp://exp.host/@vgrab/vgrab?id=${this.props.product.id}`}
            size={50}
